...
func Println(logLevel int, v ...interface{}) {
	...
	logContent := "[" + printLevelConvertMap[logLevel] + "]" + "[" + filename + ":" + strconv.Itoa(line) + "]"
...
func Printf(logLevel int, format string, v ...interface{}) {
	...
	logContent := "[" + printLevelConvertMap[logLevel] + "]" + "[" + filename + ":" + strconv.Itoa(line) + "]" + format
